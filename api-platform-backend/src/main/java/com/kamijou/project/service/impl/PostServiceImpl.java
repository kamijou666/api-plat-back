...
import com.kamijou.project.mapper.PostMapper;
import com.kamijou.project.model.entity.Post;
import com.kamijou.project.model.enums.PostReviewStatusEnum;
...
public class PostServiceImpl extends ServiceImpl<PostMapper, Post> implements PostService {
    ...
    public void validPost(Post post, boolean add) {
        ...
        // 创建时，所有参数必须非空
        if (add) {
            if (StringUtils.isAnyBlank(content, job, place, education, loveExp) || ObjectUtils.anyNull(age)) {
                throw new BusinessException(ErrorCode.PARAMS_ERROR);
            }
        }
